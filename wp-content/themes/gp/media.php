...
gp_lyrics(__('I am watching silhouettes<br/>I am talking with nothing but my ill intent to know<br/>How far you want to go<br/><br/>You are holding cheap champagne<br/>You are toasting every single face and name, and oh...<br/>Here\'s one for the show<br/><br/>You look so beautiful<br/><span> I\'m </span> You\'re losing your control'));

if (count($albums)): ?>	
<div class="posts">
	<?php gp_header(__('Discography'), array('id' => 'discography')) ?>
	<div class="entry-content">
		<?php	foreach ($albums as $album): ?>
		<h3>
			<a href="<?= get_term_link($album, 'album') ?>"><?= $album->name, ' (', $album->count, ' songs)' ?></a>
		</h3>
		<?php endforeach ?>
	</div>	
</div>	
